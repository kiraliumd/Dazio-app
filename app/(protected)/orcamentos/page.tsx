...
export default function BudgetsPage() {
  ...
  const { data: dbBudgets, loading: budgetsLoading, error: budgetsError, refresh: refreshBudgets } = useBudgets(50, startDate, endDate)
  ...
  const handleConfirmApproval = async (logisticsData: { installation: Date; removal: Date }) => {
    ...
    try {
      ...
      const rentalItems = selectedBudget.items.map((item: any) => ({
  ...
  ), [handleApproveBudget, handleViewBudget, handleEditBudget, handleDeleteBudget, handleGeneratePDF, getStatusBadge, formatDate]);
      ...
      <SidebarInset>
                  ...
                  <Table className="min-w-[800px]">
                    ...
                    <TableBody>
                      {loading ? (
                        ...
                        filteredBudgets.map((budget: Budget) => ( // This line was changed from paginatedBudgets to filteredBudgets
        ...
        <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              <AlertDialogCancel disabled={loading}>Cancelar</AlertDialogCancel> {/* This state was removed, so this line is removed */}
              <AlertDialogAction onClick={confirmDelete} className="bg-red-600 hover:bg-red-700" disabled={loading}> {/* This state was removed, so this line is removed */}
