...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🔍 Resend Contacts API: Adicionando contato:', {
      email,
      firstName,
      lastName,
    });
    ...
    if (checkResult.success && checkResult.exists) {
      ...
      if (!updateResult.success) {
        console.error(
          '❌ Resend Contacts API: Erro ao atualizar contato existente:',
          updateResult.error
        );
        return NextResponse.json(
          {
      ...
      console.log(
        '✅ Resend Contacts API: Contato atualizado com sucesso:',
    ...
    if (!addResult.success) {
      console.error(
        '❌ Resend Contacts API: Erro ao adicionar contato:',
        addResult.error
      );
      return NextResponse.json(
        {
    ...
    console.log(
      '✅ Resend Contacts API: Contato adicionado com sucesso:',
      addResult.contactId
    );
    return NextResponse.json({
      success: true,
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.log('🔍 Resend Contacts API: Atualizando contato:', {
      email,
      firstName,
      lastName,
      unsubscribed,
    ...
    if (!checkResult.success) {
      console.error(
        '❌ Resend Contacts API: Erro ao verificar contato:',
        checkResult.error
      );
      return NextResponse.json(
        {
    ...
    if (!checkResult.exists) {
      ...
      if (!addResult.success) {
        console.error(
          '❌ Resend Contacts API: Erro ao criar contato:',
          addResult.error
        );
        return NextResponse.json(
          {
      ...
      console.log(
        '✅ Resend Contacts API: Contato criado com sucesso:',
        addResult.contactId
      );
      return NextResponse.json({
        success: true,
    ...
    if (!updateResult.success) {
      console.error(
        '❌ Resend Contacts API: Erro ao atualizar contato:',
        updateResult.error
      );
      return NextResponse.json(
        {
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (!result.success) {
      console.error(
        '❌ Resend Contacts API: Erro ao desinscrever contato:',
        result.error
      );
      return NextResponse.json(
        {
    ...
    console.log(
      '✅ Resend Contacts API: Contato desinscrito com sucesso:',
      result.contactId
    );
    return NextResponse.json({
      success: true,
