    ...
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-4">Teste de Integração</h1>
          <p className="text-gray-600">Página para testar as integrações</p>
        </div>
            ...
            <div className="p-4 border rounded-lg">
              ...
              <ul className="text-sm space-y-1">
                ...
                <li>
                  ...
                  {process.env.STRIPE_ANNUAL_PRICE_ID || 'Não configurado'}
                </li>
              </ul>
            </div>
