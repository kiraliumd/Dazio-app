...
export function TrialNotification({ trialEnd, companyName }: TrialNotificationProps) {
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <AlertDescription className="text-sm">
            {isExpired ? (
              <>
                <strong>Seu período de teste expirou!</strong> Para continuar usando o {companyName}, 
                faça upgrade para um plano pago.
              </>
            ) : (
              <>
                <strong>Seu período de teste termina em {daysLeft} dias.</strong> 
