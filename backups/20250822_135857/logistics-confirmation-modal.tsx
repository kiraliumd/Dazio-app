...
const calculateLogisticsDates = (startDate: string, endDate: string) => {
    try {
        ...
        if (process.env.NODE_ENV === "development") { if (process.env.NODE_ENV === "development") { console.error("❌ ERRO em calculateLogisticsDates:", error); } }
...
export function LogisticsConfirmationModal({
  ...
  useEffect(() => {
    if (budget) {
      ...
      const logisticsDates = calculateLogisticsDates(budget.startDate, budget.endDate);
  ...
  const handleConfirm = () => {
    if (!installationDate || !installationTime || !removalDate || !removalTime) {
    ...
    if (installation >= removal) {
      alert("A data/hora de instalação deve ser anterior à data/hora de retirada.");
      return;
    }
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                <Label htmlFor="installation-date" className="text-sm">Data</Label>
            <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="installation-time" className="text-sm">Horário</Label>
                <Input
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                <Label htmlFor="removal-date" className="text-sm">Data</Label>
            <Input
                  id="removal-date"
                  type="date"
              value={removalDate}
              ...
              <div className="space-y-2">
                <Label htmlFor="removal-time" className="text-sm">Horário</Label>
                <Input
                  id="removal-time"
                  type="time"
                  value={removalTime}
