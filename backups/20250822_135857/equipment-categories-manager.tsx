...
export function EquipmentCategoriesManager({ onCategoriesChange, headerOnly = false }: EquipmentCategoriesManagerProps) {
  ...
  const loadCategories = async () => {
    try {
      ...
      if (process.env.NODE_ENV === "development") { if (process.env.NODE_ENV === "development") { console.error("Erro ao carregar categorias:", error); } }
      toast({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (process.env.NODE_ENV === "development") { if (process.env.NODE_ENV === "development") { console.error("Erro ao salvar categoria:", error); } }
      toast({
